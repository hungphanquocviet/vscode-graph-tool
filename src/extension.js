/**
 * This file contains source code adapted from zhaouv/vscode-markdown-draw (licensed Apache-2.0).
 *
 * @see https://github.com/zhaouv/vscode-markdown-draw/blob/master/src/extension.js
 */
